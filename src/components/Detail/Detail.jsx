        ...
        <div className={s.container_img_data}>
          ...
          <div className={s.container_data_btn}>
            <div className={s.container_data}>
              ...
              <p className={s.data_title_parrafo}>
                <span>Height:</span> {dogDetail[0]?.height} m.
              </p>
              <p className={s.data_title_parrafo}>
                <span>Weight:</span> {dogDetail[0]?.weight} k.
              </p>
              <p className={s.data_title_parrafo}>
                <span>Life span:</span> {dogDetail[0]?.lifeSpan}
              </p>
              <p className={s.data_title_parrafo}>
                <span>Temperament:</span> {dogDetail[0]?.temperament}
              </p>
            </div>
            <button
              onClick={handleFavorite}
              className={open ? s.btn_not : s.btn_favoritos}
              disabled={!!open}
            >
              Agregar a Favoritos
            </button>
