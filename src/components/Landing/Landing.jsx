      ...
      <div className={s.de}>
        ...
        <div className={s.sociales}>
          <ul>
            <li>
              <a
                href='https://www.linkedin.com/in/dev-sebastian-vera'
                target={'_blank'}
                rel='noreferrer'
              >
                <FaLinkedin />
            ...
            <li>
              <a
                href='https://www.github.com/wzseba'
                target={'_blank'}
                rel='noreferrer'
              >
                <FaGithub />
          ...
          <div className={s.autor}>
            Designed and built by <span>Sebastian Vera</span>
          </div>
        </div>
      </div>
    </div>
