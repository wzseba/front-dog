        ...
        <div className={s.container_fav}>
          {favorites?.map(fav => (
            <div key={fav.id} className={s.content_card_fav}>
              ...
              <h3 className={s.fav_name}>
                <span>Nombre:</span> {fav.name}
              </h3>
              <p className={s.fav_height}>
                <span>Altura:</span> {fav.height}
              </p>
              <p className={s.fav_weight}>
                <span>Peso:</span> {fav.weight}
              </p>
              <button
                className={s.fav_btn_delete}
